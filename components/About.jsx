          ...
          >
            ...
            >
              <motion.p variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }}>
                I am a passionate <span className="text-white font-bold">Full Stack Software Engineer</span> building complete, modern web applications from frontend to backend. I combine clean architecture with thoughtful design to craft fast, scalable, and intuitive digital experiences.
              </motion.p>
              <motion.p variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }}>
