          ...
          >
            ...
            >
              <motion.p variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }}>
                I am a passionate <span className="text-white font-bold">Full Stack Software Engineer</span> specializing in building production-grade enterprise applications and AI-powered systems. I combine clean architecture with thoughtful engineering to craft fast, highly scalable, and intuitive digital solutions.
              </motion.p>
              <motion.p variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }}>
                I am highly proficient in building scalable backends, microservices, and robust APIs using both <span className="text-white font-bold">TypeScript (Node.js/Next.js)</span> and <span className="text-white font-bold">Python (FastAPI)</span>. On the data layer, I architect reliable database systems with <span className="text-white font-bold">PostgreSQL</span>, <span className="text-white font-bold">MongoDB</span>, and <span className="text-white font-bold">Prisma ORM</span>, while seamlessly integrating <span className="text-white font-bold">LangChain</span>, <span className="text-white font-bold">Vector Databases</span>, and <span className="text-white font-bold">RAG systems</span> to power intelligent AI applications.
              </motion.p>
              <motion.p variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }}>
                On the frontend, I craft responsive, high-performance interfaces using <span className="text-white font-bold">React</span>, <span className="text-white font-bold">Next.js</span>, <span className="text-white font-bold">TypeScript</span>, and <span className="text-white font-bold">Tailwind CSS</span>. Production-grade projects like <span className="text-cyan-400 font-bold">DineSpot</span> reflect this end-to-end engineering rigor — combining modern web architectures with dedicated backend APIs, role-based authentication, containerization via <span className="text-white font-bold">Docker</span>, and cloud deployments across <span className="text-white font-bold">AWS</span> and <span className="text-white font-bold">Vercel</span>.
              </motion.p>
              <motion.p variants={{ hidden: { opacity: 0, y: 15 }, visible: { opacity: 1, y: 0 } }}>
                Continuous learning, architectural discipline, and real-world execution drive my work. My goal is to engineer high-impact products, collaborate with forward-thinking engineering teams, and solve complex software challenges in enterprise and startup environments.
              </motion.p>
            </motion.div>
