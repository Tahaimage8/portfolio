...
export const agentTools = [
  {
    name: 'get_profile',
    description: "Get Ibtasam Taha's verified profile information, career interests, and background.",
    parameters: {
      type: Type.OBJECT,
      properties: {},
    },
  },
  {
    ...
    description: "Verify if Ibtasam Taha has experience with a specific technology, skill, or professional requirement. Returns verification status and evidence.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        capability: {
  ...
  {
    name: 'get_projects',
    description: "Get a list of Ibtasam Taha's verified full-stack projects with their technical details.",
    parameters: {
      type: Type.OBJECT,
      properties: {
        query: {
  ...
  },
  {
    ...
    description: "Get Ibtasam Taha's public contact information and social links.",
    parameters: {
      type: Type.OBJECT,
      properties: {},
    },
